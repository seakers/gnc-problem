...
elseif strcmp(mode,'scale2')
    disp('ScaleMass in mode scale2.\n');
    % Scale sensors reliabilities only.
    kk = GNC.RelScaleFactor;
    M_SA = 3;
    M_SB = 6;
    M_SC = 9.0;
    R_SA = 0.9985;
...
elseif strcmp(mode,'scale3')
    disp('ScaleMass in mode scale3.\n');
    % Scale sensors reliabilities only.
    kk = GNC.RelScaleFactor;
    M_SA = 3;
    M_SB = 6;
...
elseif strcmp(mode,'scale4')
    disp('ScaleMass in mode scale4.');
    % Scale sensors masses only.
    rr = GNC.MassScaleFactor;
    M_SA = 3;
    M_SB = 6;
    M_SC = 9.0;
    R_SA = 1-10^-2.9;
    R_SB = 0.9990;
    R_SC = 1-10^-3.1;
    % Scaling the masses of the sensors
    M_SA = M_SB*(1-rr);
    M_SB = 6;
    M_SC = M_SB*(1+rr);
